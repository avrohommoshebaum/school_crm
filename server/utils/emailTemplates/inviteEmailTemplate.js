// server/utils/emailTemplates/inviteEmailTemplate.js
...
<head>
  ...
  <title>Welcome to Nachlas Bais Yaakov Portal</title>
</head>
          ...
          <tr>
            <td style="padding: 40px 30px;">
              ...
              <p style="margin: 0 0 20px 0; color: #333333; font-size: 16px; line-height: 1.6;">
                You have been invited to join the <strong>Nachlas Bais Yaakov School Management Portal</strong>. 
                This portal provides access to important school information, communications, and resources.
              </p>
              
              <p style="margin: 0 0 30px 0; color: #333333; font-size: 16px; line-height: 1.6;">
                To get started, please click the button below to create your account and set up your password.
              </p>
              ...
              <p style="margin: 0 0 30px 0; color: #666666; font-size: 14px; line-height: 1.6;">
                ...
                <a href="${inviteLink}" style="color: #1976d2; word-break: break-all;">${inviteLink}</a>
              </p>
              
              <!-- Info Box -->
              <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" 
                     style="background-color: #e3f2fd; border-left: 4px solid #1976d2; border-radius: 4px; padding: 15px; margin: 30px 0;">
                <tr>
                  <td>
                    <p style="margin: 0; color: #1565c0; font-size: 14px; line-height: 1.6;">
                      <strong>⏰ Important:</strong> This invitation link will expire in <strong>7 days</strong>. 
                      Please create your account as soon as possible.
                    </p>
                  </td>
                </tr>
              </table>
